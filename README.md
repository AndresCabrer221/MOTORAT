...
<head>
  ...
  <title>Moto Rat</title>
  <meta name="description" content="Moto Rat — Productos y marcas. Compare y compruebe." />
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .hero { display:flex; gap:30px; align-items:center; padding:48px 18px; }
    .hero-left { flex:1; }
...
<body>
  ...
  <main>
    <section class="hero container" id="inicio" style="background: url('moto1.png') center/cover no-repeat; border-radius: 12px; padding: 60px 18px; color: white;">
  <div class="hero-left" style="background: rgba(0,0,0,0.5); padding: 20px; border-radius: 10px;">
    <div class="logo-big">Moto Rat</div>
    <div class="tag">Agitandolo Todo — <small>-Founded 1971-</small></div>
    <p class="muted" style="color:#eee;">¡Moto Rat: Vive la ruta, rompe las reglas!</p>
    <div class="ctas">
      <a class="btn btn-primary" href="#productos">Ir a los Productos</a>
      <a class="btn btn-outline" href="#contacto" style="border-color:white;color:white;">Solicita tu Credito</a>
    </div>
  </div>
  ...
  <script>
    ...
    function acceptCookies(){
      localStorage.setItem('motorat_cookies', 'accepted');
      document.getElementById('cookieBar').style.display = 'none';
    }
    if(localStorage.getItem('motorat_cookies') === 'accepted'){
      document.getElementById('cookieBar').style.display = 'none';
    }
  </script>
</body>
